...
public class OfficeHoursDialogs {
    ...
    public static void editTADialog(Stage parent, Object titleProperty, Object headerProperty, 
                                    TableView<TeachingAssistantPrototype> taTable, OfficeHours ohws, AppTemplate app){
        ...
        ButtonType okButton= new ButtonType(props.getProperty(OH_EDIT_OK), ButtonBar.ButtonData.OK_DONE);
        ButtonType cancelButton= new ButtonType(props.getProperty(OH_EDIT_CANCEL),ButtonBar.ButtonData.CANCEL_CLOSE);
        VBox vbox= new VBox();
        Label nameLabel= new Label(props.getProperty(OH_EDIT_NAME));
        Label emailLabel= new Label(props.getProperty(OH_EDIT_EMAIL));
        TextField nameTf= new TextField();
        TextField emailTf= new TextField();
        nameTf.setText(selectedTA.getName());
        emailTf.setText(selectedTA.getEmail());
       
        RadioButton gra= new RadioButton(props.getProperty(OH_EDIT_TYPE_GRA));
        RadioButton under= new RadioButton(props.getProperty(OH_EDIT_TYPE_UNDER));
        ToggleGroup tg= new ToggleGroup();
        gra.setToggleGroup(tg);
        under.setToggleGroup(tg);
        Label typeLabel= new Label(props.getProperty(OH_EDIT_TYPE));

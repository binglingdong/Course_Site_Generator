...
public class AppFileProperties {
    static final String JSON_OH_TAB = "office_hours_tab";
    static final String JSON_MT_TAB = "meeting_times_tab";
    ...
    static final String JSON_SYL_PREREQ = "prerequisites";
    static final String JSON_SYL_OUTCOMES = "outcomes";
    static final String JSON_SYL_TB = "textbooks";
    ...
    static final String JSON_MT_DAYS = "days";
    static final String JSON_MT_TIME = "time";
    static final String JSON_MT_ROOM = "room";
    static final String JSON_MT_DAY_TIME = "day_time";
    static final String JSON_MT_LOCATION = "location";
    ...
    static final String JSON_OH_TIMESLOTS = "time";
    ...
    static final String JSON_OH_TIMESLOT_START_TIME = "time";
